...
**Question 1** *What is the dimension of your data frame ? How manies varaiables do you have and observations ? (use `nrow`, `ncole`, `class`, ``str`, `summary` and `apply` ...)*
...
**Question 2** *Count the missing values in your data set with the function `sapply`. *
...
**Question 3** *As in previous course please plot a matrix correlation  in order to analize and choose the potential  explicative variable ?*
